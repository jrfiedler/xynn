"""
Scikit-learn style classes for the TCN-Attn model
...
class TCNAttnClassifier(BaseClassifier):
    """
    Scikit-learn style classification model for the TCN-Attn model

    """

    diagram = TCNAttn.diagram
    ...
    def __init__(
        ...
        self._model_class = TCNAttn
        self._require_numeric_embedding = True

    __init__.__doc__ = INIT_DOC


class TCNAttnRegressor(BaseRegressor):
    """
    Scikit-learn style regression model for the TCN-Attn model
